...
export default function ProjetosPage() {
  const { features, unsavedCount, syncAll, setBaseLayersData } = useMapStore();
        ...
        <div className="flex items-center gap-4">
          ...
          {isLoading && (
            <span className="flex items-center gap-2 text-xs text-brand-500 font-medium">
              <span className="h-2 w-2 rounded-full bg-brand-500 animate-pulse" /> Baixando cartografia...
            </span>
          )}
        </div>
