...
const NAV_BY_ROLE: Record<Role, { label: string; href: string; icon: string; description: string }[]> = {
  SUPERADMIN: [
    ...
    { label: "Usuarios",     href: "/app/secretaria/usuarios", icon: "M17 20h5v-2a4 4 0 00-5-3.87M9 20H4v-2a4 4 0 015-3.87m8-5a4 4 0 11-8 0 4 4 0 018 0zm-8 0a4 4 0 11-8 0 4 4 0 018 0z", description: "Perfis e acessos" },
