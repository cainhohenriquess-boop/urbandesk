...
export const AUDIT_ACTIONS = {
  ...
  PROJECT_RISK_CREATE: "PROJECT_RISK_CREATE",
  PROJECT_RISK_UPDATE: "PROJECT_RISK_UPDATE",
  PROJECT_DOCUMENT_UPLOAD: "PROJECT_DOCUMENT_UPLOAD",
  PROJECT_MEASUREMENT_CREATE: "PROJECT_MEASUREMENT_CREATE",
  PROJECT_MEASUREMENT_UPDATE: "PROJECT_MEASUREMENT_UPDATE",
  PROJECT_MEASUREMENT_ATTACHMENT_UPLOAD: "PROJECT_MEASUREMENT_ATTACHMENT_UPLOAD",
  ...
  FIELD_ISSUE_CREATE: "FIELD_ISSUE_CREATE",
  INFRASTRUCTURE_LAYER_UPLOAD: "INFRASTRUCTURE_LAYER_UPLOAD",
